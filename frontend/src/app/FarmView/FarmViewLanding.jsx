...
export default function FarmViewLanding({ on3DViewClick, onDroneViewClick }) {
  return (
      ...
      <div className="z-10 max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <button
            ...
            className="group relative bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-xl rounded-3xl p-8 border border-emerald-500/20 hover:border-emerald-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-emerald-500/20"
          >
          ...
          <button
            ...
            className="group relative bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-xl rounded-3xl p-8 border border-blue-500/20 hover:border-blue-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20"
          >
            {/* Glow effect on hover */}
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-gray-500">
            💡 Both views provide real-time monitoring with live sensor data
          </p>
        </div>
      </div>
    </div>
